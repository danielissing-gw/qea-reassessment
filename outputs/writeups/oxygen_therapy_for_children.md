...
My best guess is **~10x cash at $30/patient (range ~6x at $50/patient to ~20x at $15/patient)**. The CE is driven primarily by deaths averted among children with pneumonia and is highly sensitive to per-patient costs. See [oxygen_therapy_for_children BOTEC](../botecs/oxygen_therapy_for_children.xlsx).

The original BOTEC estimated ~7x at $45/patient total ($30 philanthropic). I'm updating upward for two reasons: (1) the Uganda RCT (adjusted RR 0.51) supports a larger and better-evidenced effect than the original's adjusted RR of ~0.81, and (2) recent cost analyses suggest the original's cost assumptions may be conservative — the Malawi scale-up model finds $35/DALY averted, and CHAI's unit costs are ~$15/patient.[^8] The key caveat is that neonatal evidence remains null (Uganda RCT: IRR 1.11; Graham 2019: aOR 1.12; both NS), so benefits are concentrated in children aged 1 month to 5 years.

## Remaining uncertainties

- **Per-patient cost is the pivotal unknown.** The original BOTEC used $45/patient total or $30 philanthropic. CHAI's program data suggests ~$15/patient for CHAI costs alone. The Malawi model estimates $35/DALY.[^8] But actual costs depend heavily on facility type, electricity availability, and oxygen supply chain. Solar-powered systems (as in the Uganda RCT) add significant upfront cost but solve the power reliability problem. Costs could vary 3–5x across settings.
